...
namespace Hive {
	...
	public:
		...
		/// perform a single step of length t
		void singleStep(double t);

		/// perform a timestep of length t with the possibility of firing multiple events.
		void step(double t);
	...
	private:
		...
		/// flag
		BoolData *generate_message;

		/// flag
		BoolData *recalculate_comp;
