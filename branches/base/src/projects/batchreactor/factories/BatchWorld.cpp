...
//WHY IS THIS HERE?
Agent* BatchWorld::createAgent(Action **as) {
	return NULL;
}

//WHY IS THIS HERE?
Agent* BatchWorld::duplicateAgent(Agent *ag) {
	return NULL;
}

//WHY IS THIS HERE?
void BatchWorld::finalise() {}

void BatchWorld::addActionsToAgentsActionSet(Agent *ag) {
	UpdateCellSeenLigandAction *ucsla = new UpdateCellSeenLigandAction();
	ucsla->setAgent(ag);
	ag->addAction(ucsla);
}

void BatchWorld::addMessageGeneratorsToAgent(Agent *ag) {
...
void BatchWorld::addSimulatorToAgent(Agent *ag) {
