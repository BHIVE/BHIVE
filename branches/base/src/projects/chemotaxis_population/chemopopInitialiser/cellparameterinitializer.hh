...
namespace ChemoPop {
	...
	class CellParameterData : public ParameterData {
		public:
			...
			string additionalDataFileLocation;
			bool verboseParse;
	...
	/**
		...
		class CellParameterInitializer : public AgentInitializer {
			public:
				...
				CellParameterInitializer(string inputFileName,bool verbose);
				...
				void parseFileOldModel(ifstream& input, bool verbose);
				void parseFileWillsModel(ifstream& input, bool verbose);
				void parseFileWillsModelWithVariableMotors(ifstream& input, bool verbose);
				void parseFileFullModel(ifstream& distFile, bool verbose);
