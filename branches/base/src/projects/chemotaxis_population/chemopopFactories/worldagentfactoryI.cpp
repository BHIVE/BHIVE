...
WorldAgentFactoryI::WorldAgentFactoryI() {
	...
	cerr << "# oh, wait.  you probably wanted WorldAgentFactoryII."<<endl;
	cerr << "# as a safeguard, you have to find and remove this exception "<<endl;
	cerr << "# still want to use WorldAgentFactoryI. "<<endl;
	throw(HiveException("WorldAgentFActoryI is no longer supported.","WorldAgentFactoryI::WorldAgentFactoryI()"));
