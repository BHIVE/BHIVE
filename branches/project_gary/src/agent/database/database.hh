...
namespace Hive
{
	...
	class Database {
		public:
			 ...
			 * @param ow Pointer to the OutputWriter that outputs the database
			 */
			void dumpDataBase(OutputWriter *ow);
			
			/** outputs the observables in the database using the outputwriter
			 * @param ow Pointer to the OutputWriter that outputs the observables
			 */
