...
class Agent {
  public:
     ...
     */
    virtual void setParent(int parent_id, int node_id);
    virtual void setParent(int parent_id) { setParent(parent_id, this->node_id); }

    /** add a child of this agent
     * @param child_id id of child to add
     */
    virtual void addChild(int child_id, int node_id);
    virtual void addChild(int child_id) { addChild(child_id, this->node_id); }

    /** remove a child from this agent
     * @param child_id id of child to remove
     */
    virtual void removeChild(int child_id, int node_id);
    virtual void removeChild(int child_id) { removeChild(child_id, this->node_id); }
    ...
    /** gets communicator to the system
     */
    ...
    PropagatorClass* getPropagator() {return p;};
    void setPropagator(PropagatorClass* inP) {p = inP;};
    ...
    /** return the node ID
     * @return ID of the node on which this agent lives
     */
    int getAgentNode();
