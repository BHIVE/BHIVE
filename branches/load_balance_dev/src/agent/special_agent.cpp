...
SpecialAgent::SpecialAgent():Agent() { is_special_agent = true; this->meta = new Database();}
...
void SpecialAgent::outputCurrentState(OutputWriter *ow) {
	cerr << "#SpecialAgent::outputCurrentState(OutputWriter *ow) not implemented as of yet" << endl;
}
